...
Editor::inst( $db, 'institucioneseducativas' )
    ->fields(
        Field::inst( 'titulo' )
	...
	->join(
        Mjoin::inst( 'files' )
            ->link( 'institucioneseducativas.id', 'institucioneseducativas_files.institucioneseducativas_id' )
            ->link( 'files.id', 'institucioneseducativas_files.file_id' )
            ->fields(
                Field::inst( 'id' )
